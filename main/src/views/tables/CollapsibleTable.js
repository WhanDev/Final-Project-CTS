          ...
          >
            <TableHead>
              <TableRow>
                <TableCell />
                <TableCell>
                  <Typography variant="h6">รหัสโครงสร้าง</Typography>
                </TableCell>
                <TableCell>
                  <Typography variant="h6">หมวดวิชา</Typography>
                </TableCell>
                <TableCell>
                  <Typography variant="h6">รหัสกลุ่มวิชา</Typography>
                </TableCell>
                <TableCell>
                  <Typography variant="h6">กลุ่มวิชา</Typography>
                </TableCell>
                <TableCell>
