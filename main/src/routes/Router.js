...
const ManageAdmin = Loadable(lazy(() => import('../views/pages/Admin/Admin/ManageAdmin')));
const AddAdmin = Loadable(lazy(() => import('../views/pages/Admin/Admin/AddAdmin')));
const EditAdmin = Loadable(lazy(() => import('../views/pages/Admin/Admin/EditAdmin')));

//Officer
const IndexOfficer = Loadable(lazy(() => import('../views/pages/Admin/IndexOfficer')));

//Lecturer
const IndexLecturer = Loadable(lazy(() => import('../views/pages/Admin/IndexLecturer')));
